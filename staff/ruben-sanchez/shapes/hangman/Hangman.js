function Hangman(width, height)  {
    ...
    gallowBase.setStyle(this.width-gallowBase.width-5,this.height)
    this.add(gallowBase)

    var gallowBar1 = new Shape2D(0,200)
    gallowBar1.setStyle('border', '1px solid red')
    gallowVar1.setLocation(this.width-5-(gallowBase.width/2),this.height-gallowBar1.height)
    this.add(gallowBar1)
    ...
    rightArm.setLocation(this.width-5-(gallowBase.width/2)-gallowBar2.width,gallowBar3.height + body.height * 0.25)
    //this.add(rightArm)

    var leftArm = new Shape2D(25,0)
    leftArm.setStyle('border', '1px solid purple')
    leftArm.setLocation(this.width-5-(gallowBase/2)-gallowBar2.width -leftArm.width,gallowBar3.height + head.height + body.height * 0.25)
    // this.add(leftArm)

    var rightLeg = new Shape2D(0,25)
    rightLeg.setStyle('border','1px solid yellowgreen')
    rightLeg.setStyle('tranform-origin','top-left')
